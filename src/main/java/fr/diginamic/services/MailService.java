...
public class MailService {
  ...
  /**
   * Permet d'envoyer un email de vérification pour un utilisateur
   *
   ...
   * @throws ApiException
   */
  private void sendEmail(SendSmtpEmail sendSmtpEmail, String email, Map<String, String> params)
      throws ApiException {
  ...
  public void sendPasswordChangeEmail(TentativeChangementMdp tentativeChangementMdp, String email)
      throws ApiException {
    setDefaultClient();
    var params = new HashMap<String, String>();
  ...
  /**
   * Envoie un email à l'administrateur d'un groupe pour lui dire que l'on souhaite rejoindre le
   * groupe
   *
   ...
   * @throws ApiException
   */
  public void sendDemandeAppartenance(String senderEmail, String recipientEmail)
      throws ApiException {
    setDefaultClient();
    var params = new HashMap<String, String>();
